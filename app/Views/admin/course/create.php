...
<div class="container-fluid px-4">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <form action="<?= site_url('admin/course') ?>" method="post" enctype="multipart/form-data">
                <?= csrf_field() ?>
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="duration" name="duration" value="<?= old('duration', '0') ?>" min="0">
                                </div>
                                ...
                                <div id="premium-pricing-fields" class="<?= old('is_premium') ? '' : 'd-none' ?>">
                                    <div class="mb-3">
                                        <label for="price_amount" class="form-label">Price Amount <span class="text-danger">*</span></label>
                                        <input type="number" class="form-control" id="price_amount" name="price_amount" value="<?= old('price_amount') ?>" min="1" step="1" <?= old('is_premium') ? '' : 'disabled' ?>>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="price_currency" name="price_currency" value="<?= old('price_currency', 'IDR') ?>" maxlength="10" <?= old('is_premium') ? '' : 'disabled' ?>>
                                    </div>

                                    <div class="form-check mb-0">
                                        <input class="form-check-input" type="checkbox" id="is_purchasable" name="is_purchasable" value="1" <?= old('is_purchasable', '1') ? 'checked' : '' ?> <?= old('is_premium') ? '' : 'disabled' ?>>
